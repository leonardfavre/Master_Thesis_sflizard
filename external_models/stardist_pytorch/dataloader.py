...
class DSB2018Dataset(Dataset):
    def __init__(
        self, root_dir, n_rays, max_dist=None, transform=None, target_transform=None
    ):
...
def getDataLoaders(n_rays, max_dist, root_dir):
    trainset = DSB2018Dataset(
        root_dir=root_dir + "/train/", n_rays=n_rays, max_dist=max_dist
    )
    testset = DSB2018Dataset(
        root_dir=root_dir + "/test/", n_rays=n_rays, max_dist=max_dist
    )
