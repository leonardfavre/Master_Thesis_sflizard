...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "external_models/hover_net/logs/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "data/hover_net/training_data/lizard/lizard/train/540x540_200x200/"
        ]
        self.valid_dir_list = [
            "data/hover_net/training_data/lizard/lizard/valid/540x540_200x200/"
        ]
