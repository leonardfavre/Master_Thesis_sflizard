...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "logs/hover_net/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "data/hover_net/training_data/lizard/lizard/train/540x540_164x164/",
        ]
        self.valid_dir_list = [
            "data/hover_net/training_data/lizard/lizard/valid/540x540_164x164/"
        ]
