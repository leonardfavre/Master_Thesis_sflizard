...
if __name__ == "__main__":
    ...
    dataset_name = "lizard"
    save_root = "data/hover_net/training_data/%s/" % dataset_name

    # a dictionary to specify where the dataset path should be
    dataset_info = {
        "train": {
            "img": (".png", "data/Lizard_dataset/Lizard_Images2/"),
            "ann": (".mat", "data/Lizard_dataset/Lizard_Labels/Labels/"),
        },
        "valid": {
            "img": (".png", "data/Lizard_dataset/Lizard_Images1/"),
            "ann": (".mat", "data/Lizard_dataset/Lizard_Labels/Labels/"),
        },
    }
